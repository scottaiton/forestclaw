   ...
   do  k = 1-mbc,mz+mbc
      do j = 1-mbc,my+mbc
         do i = 1-mbc,mx+mbc
            ...
            call fclaw3dx_map_c2m(cont,blockno,xc(i)-dx2,yc(j),zc(k),xp,yp,zp)
            ...
            call fclaw3dx_map_c2m(cont,blockno,xc(i),yc(j)-dy2,zc(k),xp,yp,zp)
            ...
            call fclaw3dx_map_c2m(cont,blockno,xc(i),yc(j),zc(k)-dz2,xp,yp,zp)
